...
type Config struct {
	...
	// DisableClaudeCloakMode disables global Claude request cloaking compatibility mode.
...
type ClaudeKey struct {
	...
	// FingerprintProfile selects the Claude request fingerprint profile for this credential.
...
type CodexModel struct {
	...
	// Responses-compatible content for non-native Codex upstreams.
	IsCompat bool `yaml:"is-compat,omitempty" json:"is-compat,omitempty"`
}

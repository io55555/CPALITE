...
func TestParseGeminiCLIStreamUsageResponseSnakeCaseUsageMetadata(t *testing.T) {
...
func TestParseGeminiCLIStreamUsageIgnoresTrafficTypeOnlyUsageMetadata(t *testing.T) {

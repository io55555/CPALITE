...
import { resolveProviderDisplayLabel } from '@/utils/sourceResolverSsfun';
import styles from './MonitoringCenterSsfunInspectionPanel.module.scss';
...
export function MonitoringCenterSsfunInspectionPanel() {

      ...
      <FieldStack>
        ...
        >
          <FieldStack>
            ...
            <Divider />
            <FieldGroupHeading title={t('config_management.visual.sections.headers.xai_title')} />
            <FieldGrid>
              <FieldAnchor fieldId="xaiGrokBuildHeaderDefaults">
                <ToggleRow
                  title={t('config_management.visual.sections.headers.xai_grok_build_defaults')}
                  description={t(
                    'config_management.visual.sections.headers.xai_grok_build_defaults_desc'
                  )}
              ...
              <FieldAnchor fieldId="xaiGrokBuildHeaderDefaultsUserAgent">
                <Input
                  ...
                  onChange={(e) =>
                    onChange({ xaiGrokBuildHeaderDefaultsUserAgent: e.target.value })
                  }
                  disabled={disabled}
                />
              </FieldAnchor>
              <FieldAnchor fieldId="xaiOpenWebUICompat">
                <ToggleRow
                  ...
                  description={t(
                    'config_management.visual.sections.headers.xai_openwebui_compat_desc'
                  )}
              ...
              <FieldAnchor fieldId="xaiInjectXSearch">
                <ToggleRow
                  ...
                  description={t(
                    'config_management.visual.sections.headers.xai_inject_x_search_desc'
                  )}

...
func (h *Handler) APICall(c *gin.Context) {
	...
	httpClient.Transport = h.apiCallTransport(auth, body.ProxyURL)
...
func (h *Handler) apiCallTransport(auth *coreauth.Auth, overrideProxyURL string) http.RoundTripper {
	var proxyCandidates []string
	if proxyStr := strings.TrimSpace(overrideProxyURL); proxyStr != "" {

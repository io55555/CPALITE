...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	engine.Use(capture.RequestCaptureMiddleware())
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/capture/settings", s.mgmt.GetCaptureSettings)
		mgmt.PUT("/capture/settings", s.mgmt.PutCaptureSettings)
		mgmt.GET("/captures", s.mgmt.ListCaptures)
		mgmt.GET("/captures/export", s.mgmt.ExportCaptures)
		mgmt.GET("/captures/:id", s.mgmt.GetCapture)
		mgmt.DELETE("/captures", s.mgmt.ClearCaptures)
		mgmt.GET("/breaker", s.mgmt.GetBreakerState)
		mgmt.POST("/breaker/reset", s.mgmt.ResetBreakerState)
		mgmt.GET("/status-ruler/rules", s.mgmt.ListStatusRules)
		mgmt.PUT("/status-ruler/rules", s.mgmt.PutStatusRule)
		mgmt.DELETE("/status-ruler/rules/:id", s.mgmt.DeleteStatusRule)
		mgmt.GET("/status-ruler/hits", s.mgmt.ListStatusRuleHits)
		...
		mgmt.PATCH("/openai-compatibility/runtime-state", s.mgmt.PatchOpenAICompatRuntimeState)
		...
		mgmt.PATCH("/auth-files/runtime-state", s.mgmt.PatchAuthFileRuntimeState)
